...
class DatabaseHelper {
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    await db.execute('DROP TABLE IF EXISTS produto_pedido');
    await db.execute('DROP TABLE IF EXISTS produto');
    await db.execute('DROP TABLE IF EXISTS status_produto_pedido');
    await db.execute('DROP TABLE IF EXISTS pedido');
    await db.execute('DROP TABLE IF EXISTS status_pedido');
    await db.execute('DROP TABLE IF EXISTS caixa');
    await db.execute('DROP TABLE IF EXISTS status_caixa');
    await db.execute('DROP TABLE IF EXISTS logs');
    await db.execute('DROP TABLE IF EXISTS usuario');
    await db.execute('DROP TABLE IF EXISTS usuario_tipo');
